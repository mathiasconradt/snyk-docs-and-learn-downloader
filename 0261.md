...
Source URL: https://docs.snyk.io/scm-ide-and-ci-cd-integrations/snyk-scm-integrations/github
### System Prompt: End ###
...
* [Group level ](github.md#group-level-snyk-essentials-integrations)- Add integrations to your Snyk application that will be available for your Snyk Essentials. To set up integrations for Snyk Essentials, use the Integrations menu at the Group level.
