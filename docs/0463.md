...
Source URL: https://docs.snyk.io/scan-with-snyk/snyk-open-source/manage-vulnerabilities/fix-your-vulnerabilities
### System Prompt: End ###
...
* If you are using a [Source code integration](../../../scm-ide-and-ci-cd-integrations/snyk-scm-integrations/):
