...
Source URL: https://docs.snyk.io/enterprise-setup/single-sign-on-sso-for-authentication-to-snyk/configure-self-serve-single-sign-on-sso/okta-saml-application-setup
### System Prompt: End ###
...
3.  Navigate to [Okta](https://www.okta.com/se/login/), open the application menu, and click on **Create App Integration.**
    ...
    <figure><img src="../../../.gitbook/assets/1 (5) (1) (1).png" alt="Okta Applications main page"><figcaption><p>Okta Applications main page</p></figcaption></figure>
