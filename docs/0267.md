...
Source URL: https://docs.snyk.io/scm-ide-and-ci-cd-integrations/snyk-scm-integrations/bitbucket-cloud-app
### System Prompt: End ###
...
* [Group level ](bitbucket-cloud-app.md#group-level-snyk-essentials-integrations)- Add integrations to your Snyk application that will be available for your Snyk Essentials. If you want to set up integrations for Snyk Essentials or Snyk AppRisk, use the Integrations menu at the Group level.
