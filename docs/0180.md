...
Source URL: https://docs.snyk.io/enterprise-setup/snyk-broker/verifying-broker-image-signatures
### System Prompt: End ###
...
You must [install Cosign](https://docs.sigstore.dev/system\_config/installation/) version 2.2.0 or higher.
