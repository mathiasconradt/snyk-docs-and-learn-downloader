...
Source URL: https://docs.snyk.io/implement-snyk/walkthrough-code-repository-projects/assign-fix-work
### System Prompt: End ###
...
Snyk [Jira integration](../../integrate-with-snyk/jira-and-slack-integrations/jira-integration.md) allows you to run this process from the Snyk Web UI.
