...
Source URL: https://docs.snyk.io/scm-ide-and-ci-cd-integrations/snyk-ci-cd-integrations/github-actions-for-snyk-setup-and-checking-for-vulnerabilities/snyk-gradle-jdk17-action
### System Prompt: End ###

# Snyk Gradle-jdk17 Action

This page provides examples of using the Snyk GitHub Action for [Gradle (jdk17)](https://github.com/snyk/actions/tree/master/gradle-jdk17). For instructions on using the action and further information see [GitHub Actions integration](https://docs.snyk.io/integrations/ci-cd-integrations/github-actions-integration).
