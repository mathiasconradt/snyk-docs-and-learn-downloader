...
Source URL: https://docs.snyk.io/enterprise-setup/single-sign-on-sso-for-authentication-to-snyk/custom-mapping/examples-setting-up-custom-mapping-for-idps/example-setting-up-custom-mapping-for-google-workspace
### System Prompt: End ###
...
4.  In the **App attributes** value field, enter **roles** and click **Save**.
    ...
    <figure><img src="../../../../.gitbook/assets/x2 (1) (1).png" alt="Adding custom mapping app attribute"><figcaption><p>Adding custom mapping app attribute</p></figcaption></figure>
