...
Source URL: https://docs.snyk.io/snyk-api/using-specific-snyk-apis/webhooks-apis/guides-to-webhooks/how-to-use-snyk-webhooks-to-connect-snyk-to-slack-with-aws-lambda/slack-setup-to-connect-snyk-with-aws-lambda
### System Prompt: End ###
...
9.  Activate incoming webhooks in that page.
    ...
    <figure><img src="../../../../../.gitbook/assets/image (1) (4) (1) (1) (1) (1).png" alt=""><figcaption><p>Incoming webhooks activation</p></figcaption></figure>
